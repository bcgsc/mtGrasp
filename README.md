...
In each `<out_dir>_k<k>_kc<kc>` folder, there will be a fasta file named `post_standardization.fasta` storing the standardized mitochondrial sequence(s) and several subfolders and files containing the intermediate files generated by mitos during the mitogenome annotation step. 

Please note: `<out_dir>/final_output/<out_dir>_k<k>_kc<kc>/post_standardization.fasta` is the final output file containing the standardized mitochondrial sequence(s) generated by mtGasp. 
